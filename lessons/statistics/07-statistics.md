...
>> Bayesian statistics involves starting from prior expectations and repeatedly tempering them based on new data to provide the best current estimation of a probablity. Frequentist statistics involves using a large number of experiments to determine the frequency at a which a certain outcome occurs. Depending on the specific situation, they could produce similar or distinct interpretations.
